...
- Docs: changelog entry for 1.22.4-patch.1.

## Verify

- Hour 0 → Sunrise, 4-7 → Morning, 8-9 → Midday, 10-15 → Afternoon, 18-19 → Dusk, 20-21 → Midnight, 22-23 → Dawn. Night flag flips at hour 18.
