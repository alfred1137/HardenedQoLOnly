...
::Hardened.HooksMod.queue([">mod_reforged", ">mod_swifter", ">mod_crock_pot", ">mod_combat_simulator"], function() {
	...
	::include("mod_hardened_qol_fork/load");		// Load Hardened-Adjustments and other hooks
	::include("mod_hardened_qol_fork/ui/load");	// Load Hardened JS Adjustments and Hooks
...
::Hardened.HooksMod.queue(">mod_reforged", function() {
	::includeFiles(::IO.enumerateFiles("mod_hardened_qol_fork/api/hooks_early"));
	::includeFiles(::IO.enumerateFiles("mod_hardened_qol_fork/hooks_early"));
}, ::Hooks.QueueBucket.Early);

::Hardened.HooksMod.queue(">mod_reforged", function() {
	::includeFiles(::IO.enumerateFiles("mod_hardened_qol_fork/hooks_late"));
...
::Hardened.HooksMod.queue(">mod_reforged", function() {
	::includeFiles(::IO.enumerateFiles("mod_hardened_qol_fork/hooks_last"));
}, ::Hooks.QueueBucket.Last);

::Hardened.HooksMod.queue(">mod_reforged", function() {
	::includeFiles(::IO.enumerateFiles("mod_hardened_qol_fork/hooks_first_world_init"));
